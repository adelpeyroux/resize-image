...
uicontrol(bg1,'Style','radiobutton','String','sobel',...
	'units', 'normalized','Position',[0.0 0.0 0.5 0.5], ...
	'selected', 'on');
uicontrol(bg1,'Style','radiobutton','String','prewitt',...
	'units', 'normalized','Position',[0.5 0.0 0.5 0.5]);

uicontrol(bg1,'Style','radiobutton','String','intermediate',...
'units', 'normalized','Position',[0.0 0.5 0.5 0.5]);

uicontrol(bg1,'Style','radiobutton','String','central',...
